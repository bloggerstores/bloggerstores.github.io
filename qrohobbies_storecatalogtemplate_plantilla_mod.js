...
function product_convert() {
  $(".product:not(.field_loaded)").each(function () {
    ...
    if (_0x3cd353.mark) {
      var _markStyle = '';
      if (_0x3cd353.markbg)    _markStyle += 'background:' + _0x3cd353.markbg + ';';
      if (_0x3cd353.markcolor) _markStyle += 'color:' + _0x3cd353.markcolor + ';';
      $("figure.cover a:first", _0x1aea8b).append(
        "<span class=\"mark-badge\"" + (_markStyle ? " style=\"" + _markStyle + "\"" : "") + "><b>" + _0x3cd353.mark + "</b></span>"
      );
    }
    // ── MODO CATÁLOGO: si catalog == 'on', omitir precio, opciones y botones de compra ──
    var _0x142f07 = '';
    if (_0x3cd353.catalog != 'on') {
      _0x142f07 = "            <div class=\"price\" data-price=\"" + Number(_0x3cd353.price) + "\" data-discount=\"" + Number(_0x3cd353.discount) + "\" data-unit=\"" + _0x3cd353.unit + "\" data-weight=\"" + Number(_0x3cd353.weight) + "\"></div>        ";
    }
    if (_0x1aea8b.hasClass("is_post") && _0x3cd353.catalog != 'on') {
...
function timeago() {
  ...
  function _0x3c9fe2(_0x2b3966) {
    ...
    function fmt(n, unit) {
      ...
      return n + " " + unit + " " + _0x5a56ec;
    }

    return _0x528548 < 0xea60
      ? fmt(Math.round(_0x528548 / 0x3e8), _0x737518)
      : _0x528548 < 0x36ee80
      ? fmt(Math.round(_0x528548 / 0xea60), _0x4bda47)
      : _0x528548 < 86400000
      ? fmt(Math.round(_0x528548 / 0x36ee80), _0x1aa6b1)
      : _0x528548 < 2592000000
      ? fmt(Math.round(_0x528548 / 86400000), _0x17778f)
      : _0x528548 < 31536000000
      ? fmt(Math.round(_0x528548 / 2592000000), _0x4a9abe)
      : fmt(Math.round(_0x528548 / 31536000000), _0x21bf7e);
  }
...
function lightbox() {
  ...
  $('[data-lightbox]').each(function () {
    ...
    $(this).on('contextmenu', function () {
      alert("Todos los derechos reservados © " + $_config.page.title);
      return false;
    });
  });
